'''
The slidingpuzzle module contains classes for representing and displaying sliding puzzles.
'''
import random
import cImage
...
class SlidingPuzzleDisplay:
    ...
    def __init__(self, problem, imageFilename):
        ...
        for x in range(self.__tileWidth):
            for y in range(self.__tileHeight):
                self.__tileList[self.__problem.getBlank()].setPixel(x, y, cImage.Pixel(255, 255, 255))
